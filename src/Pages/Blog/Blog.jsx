...
const Blog = () => {
  return (
    <div className="container mx-auto my-10 px-2">
      <h1 className="text-center mb-10 font-bold text-3xl text-slate-800">
        Answer of questions
      </h1>
      ...
      <div className="collapse-content">
          ...
          <p>
           <strong>1No Answer :</strong> Every React component has a built-in state. This state is an object
            ...
            state update re-renders all relevant components. There are four main
            types of state you need to properly manage in your React apps.Let's
            cover each of these in details
          </p>

          <ol class="list-decimal ml-6">
            <li>
              {" "}
              <strong>Local state:</strong> Local (UI) state – Local state is
            ...
            <li>
              {" "}
              <strong>Global state:</strong> Global (UI) state – Global state is
              ...
              or in multiple components at least.A common example of global
              state is authenticated user state. If a user is logged into our
            ...
            <li>
              {" "}
              <strong> Server state:</strong> Server state – Data that comes
            ...
            <li>
              <strong>URL state:</strong> URL state – Data that exists on our
 ...
 {/* answer 2nd */}
        ...
        <div className="mt-5 collapse-title text-lg font-bold">
        ...
        <div className="collapse-content">
          ...
          chain.Date objects, Array objects, and Person objects inherit from
          Object.prototype.
        </div>
...
{/* answer 3rd */}
        ...
        <div className="collapse-title text-lg mt-5 font-bold">
        ...
        <div className="collapse-content">
          <ol class="list-disc ml-6">
            <ul>
              ...
              purpose of unit testing is to test the correctness of isolated
            ...
            When bugs are detected at the later stages, they are usually the
            results of many changes that have already been made to the system.
            If the software has already been developed, finding out the exact
            code that caused these bugs will be a major problem
          </ol>
        </div>
        ...
        <div className="collapse-content">
          <div className="overflow-x-auto">
            <li>
              ...
              Search or YouTube. Angular has its own library, NgRx, a project
              for state management inspired by Redux and implemented using RxJS.
            </li>
            <li>
              ...
              with React.React uses React Redux, a project maintained by the
              Redux team.
            </li>
            ...
            <li>
              ...
              Evan You, but also it counts on a huge open-source
              community.Vue.js has its own library, called Vuex.
            </li>
          </div>
        </div>
