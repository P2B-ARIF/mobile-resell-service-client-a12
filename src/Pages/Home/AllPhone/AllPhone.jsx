...
const AllPhone = () => {
  ...
  const { _id, email, image, product_name, resell_price } = modelData;
  ...
  return (
    <div className="allPhone__head container mx-auto">
      <div>
        <h1>Featured All Phone</h1>
      </div>
      <ul className="allPhone__ul">
        {allPhones.map((phone) => {
          return (
            <li key={phone._id} onClick={() => setNames(phone.category_name)}>
              <p>{phone.category_name}</p>
            </li>
          );
        })}
      </ul>
